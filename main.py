...
BITQUERY_API_KEY = os.getenv("BITQUERY_API_KEY")  # Adicione sua API Key do Bitquery aqui
...
# Configuração da API GraphQL (Pump.fun - Solana via Bitquery)
GRAPHQL_API_URL = "https://graphql.bitquery.io"
HEADERS = {
    "Content-Type": "application/json",
    "User-Agent": "Mozilla/5.0",
    "X-API-KEY": BITQUERY_API_KEY  # Adicionando autenticação via API Key
}
